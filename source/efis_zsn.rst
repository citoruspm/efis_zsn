...
Мобильное приложение предназначено для использования сотрудниками агрохимслужб в ходе выполнения полевых обследований.
...
Рисунок 474. Иконка МП ЕФИС ЗСН
2.	В окне авторизации (Рисунок 3) при необходимости ознакомиться с информацией о мобильном приложении. Для этого нажать на кнопку  .
3.	В окне авторизации вести данные учетной записи пользователя и нажать на кнопку «Войти».
 
Рисунок 475. Окно авторизации
При успешной авторизации откроется экранная форма «Карта» (Рисунок 476).
3.26.2 Работа с заданием
...
a.	Открыть экранную форму «Карта». Включив для отображения все слои, найти на карте контур сельскохозяйственного производства и нажать на объект, к которому относится задание (см. раздел 3.26.3.2).
b.	Открыть экранную форму «План заданий». С помощью панели «Фильтры» или вручную найти требуемое задание и перейти в карточку задания (см. раздел 3.26.4).
2.	В онлайн-режиме принять задание в работу для загрузки кэша топографической основы местности (см. раздел 3.26.3.2).
3.	Во время полевого выезда в карточке задания, во вкладке «Общая» ознакомиться со справочной информацией о задании (см. раздел 3.26.3.3.1).
4.	Во вкладке «Поля и точки» ввести параметры текущего поля и указанных на нем точек отбора и выполнить фотофиксацию данных объектов (см. раздел 3.26.3.3.2).
5.	Во вкладке «Кадастровые участки» ознакомиться со справочной информацией о кадастровом участке, на котором расположено поле (см. раздел 3.26.3.3.3).
6.	Во вкладке «Негативы» ввести параметры негативных факторов поля. При необходимости выполнить их фотофиксацию и записать трек обхода контуров негатива или отрисовать контуры негатива вручную на карте (см. раздел 3.26.3.3.4).
7.	Во вкладке «Контуры использования» ввести параметры контуров использования поля. При необходимости выполнить их фотофиксацию и записать трек обхода или отрисовать геометрию вручную на карте (см. раздел 3.26.3.3.5).
8.	Выполнить шаги 4-7 для каждого поля в составе задания.
9.	Завершить задание и отправить данные в систему ЕФИС ЗСН (см. Раздел 3.26.3.6).
3.26.3 Экранная форма «Карта»
Экранная форма «Карта» открывается автоматически при авторизации в приложении или при нажатии на кнопку «Карта» на панели навигации (Рисунок 476).
 
Рисунок 476. Экранная форма «Карта»
3.26.3.1 Интерфейс экранной формы «Карта»
Выбор атрибутов, которые будут присутствовать в выгрузке, осуществляется при помощи чекбоксов (Рисунок 348).
3.26.3.1.1 Слои, отображаемые на карте
На карте отображаются слои, перечисленные в Таблице 9.
Таблица 9. Слои карты
